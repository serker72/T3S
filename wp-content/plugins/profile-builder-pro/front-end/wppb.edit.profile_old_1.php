...
<!-------------------------------------------------------------------------------------->
<div class="form_wrapper" id="wppb_modify">
    <form enctype="multipart/form-data" method="post" id="edituser" class="" action="">
        
    <div class="row-fluid"  style="width: 100%; ">
        <div class="span7">
            <div class="div_user_title">Данные профиля пользователя:</div>
            <div class="div_user_last_first_name"><?php echo get_the_author_meta("last_name", $current_user->id).' '.get_the_author_meta("first_name", $current_user->id); ?></div>
        </div>
        <div class="span3">
            <div class="div_user_login_label">Логин пользователя:</div>
        </div>
        <div class="span2">
            <input type="text" id="user_login" name="user_login" size="" value="<?php echo get_the_author_meta('user_login', $current_user->id); ?>" maxlength = "60" disabled="disabled" style="width: 150px;">
        </div>
    </div>
        
    <div class="row-fluid"  style="width: 100%; ">
        <div class="span12">
            <div class="div_user_login_title">
                <span style="color: #F00;">Логин пользователя изменить нельзя</span>
            </div>
        </div>
    </div>
    ...
    <div class="row-fluid"  style="width: 100%; ">
        <div class="span6">
            <div class="row-fluid"  style="width: 100%; margin-bottom: 25px;">
                <div class="span6">
                    <input type="text" id="last_name" name="last_name" size="" value="<?php echo get_the_author_meta('last_name', $current_user->id); ?>" maxlength = "60" placeholder="Фамилия">
                </div>
                <div class="span6">
                    <input type="text" id="first_name" name="first_name" size="" value="<?php echo get_the_author_meta('first_name', $current_user->id); ?>" maxlength = "60" placeholder="Имя">
                </div>
            </div>
            
            <div class="row-fluid"  style="width: 100%; margin-bottom: 25px;">
                <div class="span6">
                    <input type="text" id="email" name="email" size="" value="<?php echo get_the_author_meta('email', $current_user->id); ?>" maxlength = "250" placeholder="e-mail">
                </div>
                <div class="span6">
                    <input type="text" id="input15" name="input15" size="" value="<?php echo get_the_author_meta('telephone', $current_user->id); ?>" maxlength = "60" placeholder="Номер телефона">
                </div>
            </div>
        </div>
        ...
        <div class="span6">
            <div class="row-fluid"  style="width: 100%; ">
                <div class="span8" style="text-align: center;">
                    <img id="" class="img_avatar" src="/wp-content/uploads/profile_builder/avatars/userID_1_originalAvatar_Button1grey-150x150.png" alt="">
                </div>
                <div class="span4">
                    <div class="row-fluid"  style="width: 100%; ">
                        <div class="span12">
                            <input type="file" id="avatar16" name="avatar16" class="inputfile inputfile-1" accept="image/jpeg,image/png,image/gif">
                            <label for="avatar16"><span>Изменить изображение</span></label>
                        </div>
                    </div>
                    
                    <div class="row-fluid"  style="width: 100%; ">
                        <div class="span12">
                            <div class="div_avatar_title">Вы можете заменить изображение, которое в дальнейшем будет отображаться в Вашем профиле</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row-fluid"  style="width: 100%; ">
        <div class="span3">
            <input type="password" id="pass1" name="pass1" size="" value="" maxlength = "60" placeholder="Новый пароль">
        </div>
        <div class="span3">
            <input type="password" id="pass2" name="pass2" size="" value="" maxlength = "60" placeholder="Повторите новый пароль">
        </div>
        <div class="span4 chekbox">
            <input type="checkbox" id="pass_show" name="pass_show" <?php echo isset($_POST['pass_show']) ? 'checked="checked"' : ''; ?>><label for="pass_show">Показать пароль</label>
        </div>
        <div class="span2">
            <input type="submit" id="pass_change" name="pass_change" value="Изменить пароль">
        </div>
    </div>
        
    <div class="row-fluid"  style="width: 100%; margin-bottom: 0px;">
        <div class="span12">
            <div style="font-size: 92%; font-style: italic;">
                <span style="color: #F00;">Напоминаем:</span> пароль не может быть короче 6-ти знаков и должен состоять ТОЛЬКО из цифр и латинских букв
            </div>
        </div>
    </div>
    ...
    <div class="row-fluid"  style="width: 100%; margin-bottom: 0px;">
        <div class="span12">
            <div class="div_user_title">Дополнительные данные для пользователей юридических лиц и физлиц-предпринимателей:</div>
        </div>
    </div>
        
    <div class="row-fluid"  style="width: 100%; margin-bottom: 20px;">
        <div class="span3">
            <input type="text" id="input2" name="input2" value="<?php echo get_the_author_meta('kod_edrpou', $current_user->id); ?>" maxlength = "10" placeholder="Код ЕДРПОУ">
        </div>
        <div class="span3">
        </div>
        <div class="span4">
            <input type="text" id="input13" name="input13" value="<?php echo get_the_author_meta('company', $current_user->id); ?>" maxlength = "250" placeholder="Название" style="width: 300px;">
        </div>
        <div class="span2">
        </div>
    </div>
