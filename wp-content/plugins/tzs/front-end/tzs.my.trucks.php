                            ...
                            <tr id="tbl_thead_records_per_page">
                                <th colspan="8" style="border: 0;">
                                    <div class="div_td_left">
                                        <?php echo ($active === '1') ? 'Публикуемый' : 'Архивный'; ?> транспорт
                                    </div>
                                    <div id="my_products_button">
                                        <?php if ($active === '1') { ?>
                                            ...
                                            <button id="all_list_button" onClick="javascript: window.open('/transport', '_self');">Общий список</button>
                                            <button id="" onClick="javascript: window.open('/account/my-trucks/?active=0', '_self');">Архивный</button>
                                        <?php } else { ?>
                                            <button id="duplicate_button">Дублировать</button>
                                            <button id="view_button">Смотреть</button>
                                            <button id="delete_button">Удалить</button>
                                            <button id="all_list_button" onClick="javascript: window.open('/transport', '_self');">Общий список</button>
                                            <button id="" onClick="javascript: window.open('/account/my-trucks/?active=1', '_self');">Публикуемый</button>
                                        <?php } ?>
                                    </div>
                                </th>
                            </tr>
